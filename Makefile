...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Thu Jul 29 16:21:04 2010
...
SOURCES       = libmaia/maiaFault.cpp \
		...
		accounteditdialog.cpp moc_maiaFault.cpp \
		moc_maiaObject.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/blogPlugin1.0.0/ && $(COPY_FILE) --parents libmaia/maiaFault.h libmaia/maiaObject.h libmaia/maiaXmlRpcClient.h libmaia/maiaXmlRpcServer.h libmaia/maiaXmlRpcServerConnection.h wordpressapi.h wordpresspost.h maindialog.h settingsdialog.h documentextractor.h accounteditdialog.h .tmp/blogPlugin1.0.0/ && $(COPY_FILE) --parents libmaia/maiaFault.cpp libmaia/maiaObject.cpp libmaia/maiaXmlRpcClient.cpp libmaia/maiaXmlRpcServer.cpp libmaia/maiaXmlRpcServerConnection.cpp wordpressapi.cpp wordpresspost.cpp main.cpp maindialog.cpp settingsdialog.cpp documentextractor.cpp accounteditdialog.cpp .tmp/blogPlugin1.0.0/ && $(COPY_FILE) --parents maindialog.ui .tmp/blogPlugin1.0.0/ && (cd `dirname .tmp/blogPlugin1.0.0` && $(TAR) blogPlugin1.0.0.tar blogPlugin1.0.0 && $(COMPRESS) blogPlugin1.0.0.tar) && $(MOVE) `dirname .tmp/blogPlugin1.0.0`/blogPlugin1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/blogPlugin1.0.0
...
compiler_moc_header_make_all: moc_maiaFault.cpp moc_maiaObject.cpp moc_maiaXmlRpcClient.cpp moc_maiaXmlRpcServer.cpp moc_maiaXmlRpcServerConnection.cpp moc_wordpressapi.cpp moc_maindialog.cpp moc_settingsdialog.cpp moc_accounteditdialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_maiaFault.cpp moc_maiaObject.cpp moc_maiaXmlRpcClient.cpp moc_maiaXmlRpcServer.cpp moc_maiaXmlRpcServerConnection.cpp moc_wordpressapi.cpp moc_maindialog.cpp moc_settingsdialog.cpp moc_accounteditdialog.cpp
