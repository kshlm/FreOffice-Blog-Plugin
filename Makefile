...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Aug 2 15:49:47 2010
...
SOURCES       = libmaia/maiaFault.cpp \
		...
		postdialog.cpp \
		blogplugin.cpp moc_maiaFault.cpp \
		moc_maiaObject.cpp \
...
compiler_moc_header_make_all: moc_maiaFault.cpp moc_maiaObject.cpp moc_maiaXmlRpcClient.cpp moc_maiaXmlRpcServer.cpp moc_maiaXmlRpcServerConnection.cpp moc_wordpressapi.cpp moc_maindialog.cpp moc_settingsdialog.cpp moc_accounteditdialog.cpp moc_postdialog.cpp moc_blogplugin.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_maiaFault.cpp moc_maiaObject.cpp moc_maiaXmlRpcClient.cpp moc_maiaXmlRpcServer.cpp moc_maiaXmlRpcServerConnection.cpp moc_wordpressapi.cpp moc_maindialog.cpp moc_settingsdialog.cpp moc_accounteditdialog.cpp moc_postdialog.cpp moc_blogplugin.cpp
