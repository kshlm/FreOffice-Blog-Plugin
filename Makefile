#############################################################################
# Makefile for building: libBlogPlugin.so
# Generated by qmake (2.01a) (Qt 4.6.2) on: Fri Aug 6 08:58:41 2010
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GL_NO_SCISSOR_TEST -DQT_DEFAULT_TEXTURE_GLYPH_CACHE_WIDTH=1024 -DQT_NO_DEBUG -DQT_PLUGIN -DQT_MAEMO5_LIB -DQT_XML_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
SOURCES       = libmaia/maiaFault.cpp \
		...
		blogplugin.cpp \
		bloggerapi.cpp \
		bloggerpost.cpp moc_maiaFault.cpp \
		moc_maiaObject.cpp \
...
DESTDIR       = 
TARGET        = libBlogPlugin.so
TARGETD       = libBlogPlugin.so
...
$(TARGET): ui_maindialog.h $(OBJECTS) $(SUBLIBS) $(OBJCOMP)  
	-$(DEL_FILE) $(TARGET)
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/BlogPlugin1.0.0/ && $(COPY_FILE) --parents libmaia/maiaFault.h libmaia/maiaObject.h libmaia/maiaXmlRpcClient.h libmaia/maiaXmlRpcServer.h libmaia/maiaXmlRpcServerConnection.h wordpressapi.h wordpresspost.h maindialog.h settingsdialog.h documentextractor.h accounteditdialog.h postdialog.h blogplugin.h bloggerapi.h bloggerpost.h .tmp/BlogPlugin1.0.0/ && $(COPY_FILE) --parents libmaia/maiaFault.cpp libmaia/maiaObject.cpp libmaia/maiaXmlRpcClient.cpp libmaia/maiaXmlRpcServer.cpp libmaia/maiaXmlRpcServerConnection.cpp wordpressapi.cpp wordpresspost.cpp maindialog.cpp settingsdialog.cpp documentextractor.cpp accounteditdialog.cpp postdialog.cpp blogplugin.cpp bloggerapi.cpp bloggerpost.cpp .tmp/BlogPlugin1.0.0/ && $(COPY_FILE) --parents maindialog.ui .tmp/BlogPlugin1.0.0/ && (cd `dirname .tmp/BlogPlugin1.0.0` && $(TAR) BlogPlugin1.0.0.tar BlogPlugin1.0.0 && $(COMPRESS) BlogPlugin1.0.0.tar) && $(MOVE) `dirname .tmp/BlogPlugin1.0.0`/BlogPlugin1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/BlogPlugin1.0.0
...
compiler_moc_header_make_all: moc_maiaFault.cpp moc_maiaObject.cpp moc_maiaXmlRpcClient.cpp moc_maiaXmlRpcServer.cpp moc_maiaXmlRpcServerConnection.cpp moc_wordpressapi.cpp moc_maindialog.cpp moc_settingsdialog.cpp moc_accounteditdialog.cpp moc_postdialog.cpp moc_blogplugin.cpp moc_bloggerapi.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_maiaFault.cpp moc_maiaObject.cpp moc_maiaXmlRpcClient.cpp moc_maiaXmlRpcServer.cpp moc_maiaXmlRpcServerConnection.cpp moc_wordpressapi.cpp moc_maindialog.cpp moc_settingsdialog.cpp moc_accounteditdialog.cpp moc_postdialog.cpp moc_blogplugin.cpp moc_bloggerapi.cpp
...
moc_blogplugin.cpp: blogplugin.h
	/usr/bin/moc $(DEFINES) $(INCPATH) blogplugin.h -o moc_blogplugin.cpp

moc_bloggerapi.cpp: bloggerapi.h
	/usr/bin/moc $(DEFINES) $(INCPATH) bloggerapi.h -o moc_bloggerapi.cpp
...
blogplugin.o: blogplugin.cpp blogplugin.h \
		maindialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o blogplugin.o blogplugin.cpp

bloggerapi.o: bloggerapi.cpp bloggerapi.h \
		bloggerpost.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bloggerapi.o bloggerapi.cpp

bloggerpost.o: bloggerpost.cpp bloggerpost.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bloggerpost.o bloggerpost.cpp
...
moc_blogplugin.o: moc_blogplugin.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_blogplugin.o moc_blogplugin.cpp

moc_bloggerapi.o: moc_bloggerapi.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_bloggerapi.o moc_bloggerapi.cpp
